						   ...
						   <h3 class="box-title">Billing Address</h3>
							<div class="billing-adress">
								...
								<p class="row-in-form">
									...
									<input  type="text" name="country" value="" placeholder="Turkey" wire:model="country">
									@error('country')
										<span class="text-danger">{{$message}}</span>
									@enderror
								</p>							
						...
						<div class="col-md-12">
							...
							<h3 class="box-title">Shipping Address</h3>
								<div class="billing-adress">
									...
									<p class="row-in-form">
										<label for="country">Country<span>*</span></label>
										<input  type="text" name="country" value="" placeholder="Turkey" wire:model="s_country">
										@error('s_country')
										<span class="text-danger">{{$message}}</span>
									@enderror
									</p>
									...
									<p class="row-in-form">
										<label for="zip-code">Postcode / ZIP:</label>
										<input code" type="number" name="zip-code" value="" placeholder="Your postal code" wire:model="s_zipcode">
										@error('s_zip')
										<span class="text-danger">{{$message}}</span>
									@enderror
									</p>
