        ...
        <div class=" main-content-area">
                    ...
                    @foreach (Cart::instance('cart')->content() as $item)
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="quantity">
                                ...
                                <p class="text-center"><a href="#" wire:click.prevent="switchToSaveForLater('{{$item->rowId}}')">Save For Later</p>
                            </div>
                ...
                <div class="summary">
                    <div class="order-summary">
                        ...
                        <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}})
                            <a href="" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger" style="padding-left: 10px" aria-hidden="true"></i></a>
                        </span><b class="index">- ${{$discount}}</b></p>
            ...
            <div class="wrap-iten-in-cart">
                ...
                @if (Session::has('s_success'))
                    <div class="alert alert-success">
                        <strong>{{ Session::get('s_success') }}</strong>
                    </div>         
                ...
                @if(Cart::instance('saveForLater')->count() >0)
                   ...
                   @foreach (Cart::instance('saveForLater')->content() as $item)
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="price-field produtc-price"><p class="price">${{$item->model->regular_price}}</p></div>
                            <div class="quantity">
                               <p class="text-center"><a href="#" wire:click.prevent="moveToCart('{{$item->rowId}}')">Move To Cart</p>
                            </div>
                            <div class="delete">
