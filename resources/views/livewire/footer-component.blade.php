								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											...
											<li><a href="{{$settings->github}}" class="link-to-item" title="github"><i class="fa fa-github" aria-hidden="true"></i></a></li>
											<li><a href="{{$settings->linkedin}}" class="link-to-item" title="linkedin"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
